...
struct Camera{F<:AbstractFloat,FC<:Union{ScalarFunc{F},Nothing},MF<:AbstractMatrix{F}}
    ...
    canvas::Array{F,3}
    warp!::Transform{F,MF,Base.Slice{Base.OneTo{Int64}}}
...
"""
Get the resolution (n_y, n_x) ∈ N^2 of the camera
"""
...
function set_warp(camera::Camera{F,FC,MF}, warp!::Function)::Camera{F} where {F,FC,MF}
    warp! = Transform{F,MF,Base.Slice{Base.OneTo{Int64}}}(warp!)
...
"""
loc: The origin of the rays
dir: The direction of the rays (unit vectors)
the arrays are assumed to be of shape (n_rays, 3)
"""
...
"""
Compute the location and direction of a ray emitted from the camera for 
