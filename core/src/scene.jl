...
function create_intersector(
    ...
    return intersection -> begin
        affine_transform!(intersection.ray, intersection.ray_camera, transform)
...
function Base.push!(
    ...
    scene.intersectors[name] = Intersector{F}(create_intersector(shape, transform))
...
function set_transform!(
    ...
    scene.intersectors[shape_name] = Intersector{F}(create_intersector(shape, transform))
end
